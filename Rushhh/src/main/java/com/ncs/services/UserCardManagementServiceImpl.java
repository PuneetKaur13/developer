...
@Service("userCardManagementService")
public class UserCardManagementServiceImpl extends BaseServiceImpl implements UserCardManagementServiceI{

	@Override
	@Autowired
	@Qualifier("userCardManagementDAO")
