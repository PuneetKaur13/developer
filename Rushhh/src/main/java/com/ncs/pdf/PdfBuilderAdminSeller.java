...
public class PdfBuilderAdminSeller {
	
	private static Font TIME_ROMAN = new Font(Font.FontFamily.TIMES_ROMAN, 8, Font.BOLD);
	private static Font TIME_ROMAN_SMALL = new Font(Font.FontFamily.TIMES_ROMAN, 8, Font.NORMAL);

	private static Font TIME_ROMAN_BOLD = new Font(Font.FontFamily.TIMES_ROMAN, 8, Font.BOLD);
