mainApp.controller("PlantInformationController", function($http, $scope,
	...
	// Service endpoint
	self.endPoint = "/OCBS/rest/PlantInformation";
	...
	// Submits data and add/edit record
	self.updatePlantInfo = function(ctl) {
		self.message = "Please Wait..";
		var endPoint = self.endPoint + "/updatePlantInfo";
