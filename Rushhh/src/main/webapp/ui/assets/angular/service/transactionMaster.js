mainApp.factory("TransactionMasterService", function($http) {
	list = [];
	companyList = [];
	formData = [];
	progress = "";
	...
	var endpoint = "/OCBS/rest/TransactionMaster";
	...
	return {
		...
		addData : function(role, pageNo, pageSize) {
			var reload = this;
			successMsg = [];
			progress = "Please Wait..";
		...
		updateData : function(role, pageNo, pageSize) {
			var reload = this;
			successMsg = [];
			progress = "Please Wait..";
		...
		searchByCompany : function(branch, pageNo, pageSize) {
			var reload = this;
			console.log(branch)
			progress = "Please Wait..";
