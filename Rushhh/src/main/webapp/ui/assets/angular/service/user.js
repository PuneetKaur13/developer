mainApp.factory("UserService", function($http, $location) {
	list = [];
	listByUser = [];
	formData = [];
	roleList = [];
...
authenticate:function(user) {
			...
			if(!serverRes.success  && serverRes.message == 'DISAPPROVED'){
		...
		authenticateGoogle:function(user) {
			
			successMsg = [];
			//progress = "Please Wait..";
			var subpoint = endpoint + "/authenticationGoogle";
			$http({
				method : 'POST',
				url : subpoint,
				data : user
		...
		deleteData : function(checkId, pageNo, pageSize) {
			var reload = this;
			progress = "Please Wait..";
			var subpoint = endpoint + "/deleteA/" + checkId;
			$http({
				method : 'POST',
				url : subpoint
			}).success(function(data, status, headers, config) {
		...
		notificationList : function() {
			...
			var subpoint = "/Rushhh/rest/Notification/getNotificationCount";
			$http({
				method : 'GET',
				url : subpoint,
			}).success(function(data, status, headers, config) {
		...
		roleList : function() {
			progress = "Please Wait..";
			var subpoint = "/Rushhh/rest/Role/search";
			$http({
				method : 'POST',
				url : subpoint,
			}).success(function(data, status, headers, config) {
		...
		companyList : function() {
			progress = "";
			var subpoint = "/Rushhh/rest/Company/searchNotNull";
			$http({
				method : 'POST',
				url : subpoint,
