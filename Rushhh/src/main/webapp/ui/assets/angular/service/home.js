mainApp.factory("HomeService", function($http, $location) {
	buyerBiddigList = [];
	sellerBiddigList = [];
	buyerByCityList = [];
	sellerByCityList = [];
	...
	return {
		...
		buyerBiddigList : function() {
			...
			var subpoint = "/Rushhh/rest/BuyerBidding/searchforMap";
			$http({
				method : 'GET',
				url : subpoint
		...
		sellerBiddigList : function() {
			progress = "Please Wait..";
			var subpoint = "/Rushhh/rest/SellerBidding/searchforMap";
			$http({
				method : 'GET',
				url : subpoint
			}).success(function(data, status, headers, config) {
		...
		showBuyerByCity : function(city) {
			progress = "Please Wait..";
			var subpoint = "/Rushhh/rest/BuyerBidding/searchByCity/" + city;
			$http({
				method : 'GET',
				url : subpoint
			}).success(function(data, status, headers, config) {
		...
		showSellerByCity : function(city) {
			progress = "Please Wait..";
			var subpoint = "/Rushhh/rest/SellerBidding/searchByCity/" + city;
			$http({
				method : 'GET',
				url : subpoint
			}).success(function(data, status, headers, config) {
		...
		setSessionProduct : function(productId) {
			progress = "Please Wait..";
			var subpoint = "/Rushhh/rest/AdminProduct/setSessionProduct/"
					+ productId;
			$http({
				method : 'GET',
				url : subpoint
		...
		setUserType : function(type) {
			progress = "Please Wait..";
			var subpoint = "/Rushhh/rest/Users/setUserType/" + type;
			$http({
				method : 'GET',
				url : subpoint
			}).success(function(data, status, headers, config) {
		...
		getSessionProduct : function() {
			progress = "Please Wait..";
			var subpoint = "/Rushhh/rest/AdminProduct/getSessionProduct";
			$http({
				method : 'GET',
				url : subpoint
			}).success(function(data, status, headers, config) {
