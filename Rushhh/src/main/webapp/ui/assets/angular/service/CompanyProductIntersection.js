mainApp.factory("CompanyProductIntersectionService", function($http) {
	list = [];
	formData = [];
	progress = "";
	successMsg = "";
	...
	var endpoint = "/OCBS/rest/CompanyProductIntersection";
	...
	return {
		...
		productList : function() {
			progress = "";
			var subpoint = "/OCBS/rest/AdminProduct/searchProduct";
			$http({
				method : 'POST',
				url : subpoint,
			}).success(function(serverRes, status, headers, config) {
