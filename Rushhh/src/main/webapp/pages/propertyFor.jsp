				...
				<div id="page-wrapper">
					...
					<div class="table-responsive">
						<table>
							<tr>
								<td><input type="text" class="form-control"
									ng-model="ctl.searchData.propertyForName"
									placeholder="Search PropertyFor Name"></td>
						...
						<table class="table table-bordered table-striped table-hover"
							...
							<tbody>
								<tr ng-repeat="propertyFor in ctl.dataList.list | orderBy:'properttyForName' track by propertyFor.id">
									<td align="center"><input type="checkbox"
										checklist-model="ctl.checkedData.del"
										checklist-value="propertyFor.id"></td>
									<td align="center"><a href=""
										ng-click="ctl.display(propertyFor.id)" data-toggle="modal"
										data-target="#mainModal"><span
											class="glyphicon glyphicon-pencil"></span></a></td>
									<td align="center">{{$index+1}}</td>
									<td align="center">{{propertyFor.propertyForName}}
									</td>
								</tr>
							</tbody>
						</table>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header"style="background-color:#64b5f6">
				...
				<h4 class="modal-title">PropertyFor</h4>
			</div>
			<form class="form-horizontal" role="form" ng-submit="ctl.submit()">
				<div class="modal-body">
					...
					<div class="form-group">
						<label for="type" class="col-sm-3 control-label"> PropertyFor :
							<span style="color: red;">*</span>
						</label>
						<div class="col-sm-7">
							<input type="text" ng-model="ctl.form.propertyForName"
								class="form-control" placeholder="Enter PropertyFor" required>
						</div>
					</div>
