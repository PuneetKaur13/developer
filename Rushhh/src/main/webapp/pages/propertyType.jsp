				...
				<div id="page-wrapper">
					...
					<div class="table-responsive">
						<table>
							<tr>
								<td><input type="text" class="form-control"
									ng-model="ctl.searchData.propertyTypeName"
									placeholder="Search PropertyType "></td>
						...
						<table class="table table-bordered table-striped table-hover"
							...
							<tbody>
								<tr ng-repeat="propertyType in ctl.dataList.list | orderBy:'propertyTypeName' track by propertyType.id">
									<td align="center"><input type="checkbox"
										checklist-model="ctl.checkedData.del"
										checklist-value="propertyType.id"></td>
									<td align="center"><a href=""
										ng-click="ctl.display(propertyType.id)" data-toggle="modal"
										data-target="#mainModal"><span
											class="glyphicon glyphicon-pencil"></span></a></td>
									<td align="center">{{$index+1}}</td>
									<td align="center">{{propertyType.propertyTypeName}}
									</td>
								</tr>
							</tbody>
						</table>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header"style="background-color:#64b5f6">
				...
				<h4 class="modal-title">PropertyType</h4>
			</div>
			<form class="form-horizontal" role="form" ng-submit="ctl.submit()">
				<div class="modal-body">
					...
					<div class="form-group">
						<label for="type" class="col-sm-3 control-label"> PropertyType :
							<span style="color: red;">*</span>
						</label>
						<div class="col-sm-7">
							<input type="text" ng-model="ctl.form.propertyTypeName"
								class="form-control" placeholder="Enter PropertyType" required>
						</div>
					</div>
